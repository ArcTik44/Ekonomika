...
- Ve vyšší úrovni jsou potřeby sociální
...
- Hmotné
  - rohlík, tričko, mobil
- Nehmotné
  - znalosti, vědomosti, dovednosti,...
- Podle jejich dostupnosti:
- Volné - jsou dostupné každému zdarma, např. vzduch, voda v přírodě, slunce,..
- Vázané - pro jejich získání musíme vynaložit úsilí - peníze nebo práci

	# Služby
- Služby jsou činnosti jiných lidí, které uspokojují naše potřeby
- Druhy:
- Věcné - týkjí se věcí, např. oprava auta, oprava bot
- Osobní - týkají se osob, např. kadeřnictví, masáže, lékařské zákroky
- Proce uspokojování potřeb se nazývá spotřeba
- ŽIVOTNÍ ÚROVEŇ - míra, s jakou můžeme uspokojovat své potřeby

	# Výroba a výrobní faktory
- Je činnost, při které člověk přetváří přírodu na statky
- K výrobě jsou potřeba 3 výrobní faktory:
- Práce 
- Půda
- Kapitál
...
- Pracovní síla = souhrn duševních a fyzických schopností člověka vykonávat práci
- Pracovní sílu nemá každý, např. děti, důchodci, nemocní
- Každý člověk nemusí svou pracovní sílu využívat (např. žije z dědictví, výhry, zabezpečí ho partner) - práce
je vzácný výrobní faktor
- Oceněním za práci je mzda nebo plat
- Druhy mzdy:
  - nominální - je vyjádřena v penězích
  - reálná - je vyjádřena ve zboží, které si za ni mohu koupit
  - minimální - v ČR činí od 1.8.2013 8.500 Kč
Vlivy na výši mzdy:
- Vzdělání
- Praxe
- Kvalita a množství práce
- Pohlaví
- Území
- Zodpovědnost a namáhavost práce
- Poptávka na trhu práce

	Nabídka a poptávka na trhu práce
- Nabídka na trhu práce = zaměstnanci
- Poptávka na trhu práce = firmy, podniky
- N>P - nezaměstnanost
- N<P - nedostatek pracovní síly (řešení práce v zahraničí, lepší organizace práce)

	Půda, přírodní zdroje
- Půda je potřebná pro všechny lidské činnosti (stavebnictví, zemědělství, ...) a má tendenci ubývat - půda je
vzácný výrobní faktor
- Majitel půdy má výsadní postavení - monopol
- 3 možnosti využití půdy:
  - Prodej - za tržní cenu
  - Podnikání - za zisk
  - Pronájem - za pozemkovou rentu
    - Absolutní - základní sazba za pronájem jakékoliv půdy
    - Diferenční - záleží na bonitě (kvalitě) půdy (bonitu zvyšuje: lokalita, kvalita, inženýrské sítě, naleziště sur.)

- Přírodní zdroje:
  - S přírodními zdroji se obchoduje na komoditních burzách 
  - ČR - Brno
- Kapitál je vše, co nám může vynést větší hodnoty
  - hmotný - pozemky, stroje
  - nehmotný - licence, patenty, značka, sw, know-how
  - finanční - peníze, cenné papíry
- 2 možnosti využití kapitálu:
  - investovat, podnikat - za zisk
  - půjčit, spořit - za úrok
- Kapitál se dá také akumulovat (hromadit) pro pozdější vyšší investice
- Trh kapitálu v peněžní podobě se nazývá finanční trh a účastní se ho:
  - banky, pojišťovny, spořitelny, burzy, podílové fondy, investiční fondy
- Jako 4. výrobní faktor se někdy označují INFORMACE
- Jako 5. výrobní faktor se uvádí PODNIKAVOST

	# Hospodářský proces
- Je proces uspokojování lidských potřeb na úrovni národního hospodářství
- Má 4 fáze:
  - 1) Výroba - činnost, při které člověk přetváří přírodu ve statky za působení 3 výrobních faktorů
  - Při výrobě se hodnotí její:
  - efektivnost (kolik korun zisku připadne na jednu vloženou korunu) a 
  - produktivnost (kolik korun výstupu připadá na 1 pracovníka)

	# Hranice produkčních možností
- Výrobní faktory každé země jsou omezené
- Každá země má hranici produkčních možností, pokud vyrábí efektině, pohybuje se právě na této hranici
(výrobní faktory jsou využité na 100%)
- Ekonomika vyrábí efektivně, když nemůže vyrábět více jednoho statku, aniž by vyráběla méně jiného statku
- Pokud se pohybuje země s výrobou na hranici produkčních možností (bod A), vyrábí efektivně
- Pokud je pod hranicí v bodě B, nejsou využity všehny výrobní faktory v plné míře
- Pokud by se země chtěla dostat s výrobou nad hranici produkčních možností (bod C), musela by buď:
  - zlepšit organizaci práce a tím zvýšit její produktivitu
  - získat nové technologie a tím práci usnadnit
  - přijmout nové pracovní síly ze zahraničí 
  - 2) Přerozdělování a rozdělování -
        a) rozdělování - účastníci výroby získávají své odměny (např. zaměstnanci - mzdu, majitelé kapitálu - 
zisk nebo úrok, majitelé pozemků - rentu)
        b) přerozdělování - část vydělaných peněz odvádí účastníci výroby (FO,PO) formou daní do státního
rozpočtu (SR) a tyto peníze se přerozdělí těm, kteří se nemohli účastnit výroby (děti, důchodci, nemocní,
nezaměstnání) ve formě sociálních dávek 
   - 3) Směna - zákazníci si nakoupí od nabízejících zboží a služby za peníze, které získali ve 2. fázi, až nyní se
ukáže, zda firmy nevyráběly zboží zbytečně a zda najde své zákazníky
   - 4) Spotřeba - uspokojování potřeb
          - konečná - pro potřeby jednotlivců
          - výrobní - pro potřeby firem
...
- Nabídka (supply) - množství zboží, které jsou nabízející ochotni za danou cenu prodat
	
	## Nabídka
- Zákon nabídky: s rostoucí cenou nabídka zboží stoupá
- Druhy nabídky: 
  - Individuální - nabídka jednoho druhu výrobku nebo jednoho výrobce
  - Dílčí (tržní) - nabídka všech výrobců jednoho druhu zboží
  - Agregátní - nabídka všech druhů zboží a všech výrobců
- Faktory ovlivňující nabídku:
  - Náklady
  - Poptávka
  - Konkurence
  - Umístění firmy
  - Vnější podmínky (zákony, daně, nařízení, vlády,...)
- Posuny křivky nabídky
  - růst nabídky (posun grafu doprava) - důvod např. pokles nákladů na výrobu

	## Poptávka
- Množství zboží, které jsou zákazníci ochotni za danou cenu koupit
- Zákon poptávky:
  - s klesající cenou poptávka roste
- Druhy poptávky:
  - Individuální - poptávka jednoho zákazníka
  - Dílčí (tržní) - poptávka všech zákazníků po jednom druhu zboží
  - Agregátní - poptávka všech zákazníků po všech druzích zboží
- Faktory ovlivňující poptávku:
  - Cena (+ elasticita poptávky)
  - Kvalita
  - Reklama, značka, móda
  - Finanční situace
  - demografické faktory (věk, pohlaví, náboženství, vzdělání,...)
  - Ceny substitutů (náhradního zboží) např. místo jablek koupíme hrušky
  - Ceny komplementů (zboží, které se při spotřebě musí vzájemně doplňovat) např. auto + benzín
- Posuny křivky poptávky - růst poptávky (posun křivky doprava) - důvod např. růst příjmů, zdražení substitutů
zlevnění 
- Elasticita poptávky - Elasticita udává, jak se změní poptávka při změně ceny
- Elastická poptávka - i drobná změna ceny výrazně neovlivní její výši
- Neelastická poptávka - změna ceny má velmi malý nebo žádný vliv na poptávku
- Poptávka je neelastická:
  - u nezbytných statků - např. pečivo, palivo, elektřina
  - u těžko nahraditelných statků - nemají substitut - mléko, sůl
...
k.s., s.r.o., a.s.), družstva, státní podniky, ostatní podniky (např. konsorcia)
  ...
  - Podniky nezapsané v OR (např. soukromé školy)
...
- Např. - výroba zbraní, taxi služba, pohřební služba, telekomunikace, cestovní kanceláře, televize a rozhlas
- Odborná způsobilost je uvedena v příloze č.3 živnostenského zákona, před zahájením podnikání musíme
počkat na vydání koncesní listiny
- Pokud podnikatel nesplňuje podmínku odborné způsobilosti, může ustanovit odpovědného zástupce, který
tuto podmínku splňuje

- Živnost nelze provozovat, když:
  - Soud udělil podnikateli zákaz činnosti v oboru
  - Na majetek podnikatele byl vyhlášen konkurz
  - Konkurz byl zrušen pro nedostatek majetku
- Zánik živnostenského oprávnění:
  - Smrtí podnikatele
  - Zánikem právnické osoby, výmazem zahraniční osoby z obchodního rejstříku
  - Uplynutím doby, na kterou bylo oprávnění vydáno
  - Rozhodnutí živnostenského úřadu o zrušení živnostenského oprávnění
- Některé povinnosti podnikatelů podle živnostenského zákona:
  - Doložit kontrolním orgánům způsob získání prodávaného zboží
  - Na požádání zákazníka vydávat doklady o prodeji zboží (kopie uchovávat 3 roky)
  - Zajistit, aby v provozovně byla přítomná osoba znalá ČJ

    ## Obchodní korporace
  - Jsou právnické osoby (PO) založené za účelem podnikání (nejen v obchodě)
	
    ## Osobní obchodní společnosti
- Charakteristické rysy:
  - Vyžaduje se osobní účast společníků na řízení společnosti (proto nemusí mít statutární orgány)
  - Při založení se do nich nemusí vkládat základní kapitál
  - Ručení společníků za závazky společnosti je neomezené (ručí celým svým i osobním majetkem) a solidární (kterýkoli společník musí na požádání zaplatit věřiteli celý dluh a teprve následně se vyrovnává s ostatními
společníky)
- např. Veřejná obchodní společnost (v.o.s.), Komaditní společnost (k.s.)

	## Kapitálové obchodní společnosti
- Charakteristické rysy:
  - Nevyžaduje se osobní účast společníků na řízení
  - Společníci povinně vytváří svými vklady základní kapitál
  - Ručení za závazky společnosti je omezené výší vkladů a základního kapitálu
  - Musí vytvářet statutární orgány
- např. Společnost s ručením omezeným (s.r.o.), Akciová společnost (a.s.)

	## Veřejná obchodní společnost (v.o.s.)
- Patří mezi osobní obchodní společnosti
- Je založena minimálně 2 osobami
- Může být založena jak FO, tak i PO
- Za závazky ručí společníci neomezeně a solidárně celým majetkem
- Řídící (statutární) orgán je každý společník
- Zisk se dělí mezi společníky rovným dílem, stejně tak i ztráta
- Zisk se zdaňuje podle zákona o dani z příjmu FO až u jednotlivých společníků
- Pro společníky platí zákaz konkurence v oboru
- Vstoupit nebo vystoupit ze spol. je možné pouze na základě změny společenské smlouvy, vždy musí zůstat alespoň 2 společníci
- Ke zrušení firmy dojde i tehdy, je-li na majetek některého společníka vyhlášen konkurz
- Smrtí společníka dojde ke zrušení a zániku celé společnosti (s výjimkou dědění práv)
- Při založení v.o.s. se nemusí vkládat žádný povinný vklad ani majetek, netvoří se základní kapitál
...
- Probíhá na kapitálovém trhu - na burze cenných papírů nebo přes RM-Systém
- Akcie se vydávají za emisní kurz, ale prodávají se za tržní cenu, která může být vyšší, ale i nižší než původní emisní cena
- r. 2010 přes účastníka CDCP (to je obchodník CDCP)

- Založení a.s.:
  - Akciová společnost může být založena minimálně jednou PO nebo 2 a více FO, celkový počet společníků je neomezen
  - Založení: - základní kapitál je minimálně 2.000.000,- Kč
  - K založení se vyžaduje přijetí stanov, a to ve formě veřejné listiny (notářský zápis)
  - Vznik: dnem zápisem do OR
  - Při upisování musí být zaplaceno 10% z hodnoty akcií, do ustavující valné hromady 30% hodnoty akcií
  - Do zaplacení celé částky obdrží akcionáři zatímní listy, po zaplacení celé částky získají akcie
  - Do 60 dnů od skončení upisování akcií se musí konat ustavující valná hromada, která schválí stanovy společnosti a zvolí řídící orgány
- Orgány společnosti - 2 možné varianty vnitřní struktury a.s.:
  - První varianta = dualistický systém
       - Nejvyšší orgán - valná hromada
	- Schází se minimálně 1x ročně
	- Její rozhodnutí platí při účasti akcionářů s minimální hodnotou 30% všech akcií
	
- Akcie = cenný papír, se kterým jsou spojena 3 práva:
  - podílet se na zisku formou dividendy
  - účastnit se a hlasovat na valné  hromadě (podílet se na řízení a.s.)
- Zákaz konkurence v oboru platí pro členy dozorčí rady a představenstva
- Odměny pro členy dozorčí rady a představenstva se nazývají TANTIEMY
- Společnost musí být zapsána do OR do 6 měsíců od ustavující valné hromady
- A.S. tvoří postupně ze zisku povinně rezervní fond ve výši 20% z hodnoty ZK
- O rozdělení zisku rozhoduje valná hromada a zdaňuje se jako u s.r.o. (nejdříve za celou firmu daní z příjmu PO a pak se každý společník
sám za sebe daní z příjmu FO)
	
	## Družstvo
- Je společenství neuzavřeného počtu osob založené za účelem podnikání nebo zajišťování hsopodářských, sociálních nebo jiných
potřeb svých členů
- Družstvo musí mít minimálně 3 členy
- Členem družstva se může stát osoba od 15 let věku
- Minimální základní kapitál je 50.000,- kč
- podmínkou členství v družstvu je zaplacení členského vkladu
- Orgán družstva:
  - Nejvyšší orgán = členská schůze
    - Schází se min. 1x ročně
    - Má podobné pravomoci jako valná hromada u s.r.o. a u a.s.
  - Statutární orgán = představenstvo
    - V čele představenstva je předseda, řídí činnost družstva
  - Kontrolní orgán = kontrolní komise
    - Kontroluje činnost představenstva
    - Řeší stížnosti členů družstva
- Funkční období členů všech orgánů družstva je max. 5 let
- Pro členy představenstva a kontrolní komise platí zákaz konkurence v oboru
- Členové ručí za závazky pouze do výše svého vkladu
- Družstvo povinně vytváří nedělitelný fond v konečné výši minimálně poloviny ze ZK
- K založení družstva dochází na ustanovující členské schůzi, které schválí stanovy, zvolí řídící orgány a určí ZK
- Vznik družstva nastává dnem zápisu do OR
- Zisk se zdaňuje jako u s.r.o.
- Obory činnosti družstev:
  - Zemědělská
  - Bytová
  - Obchodní
  - Výrobní
...
- Obchodní logistika
  - Zabývá se optimálním řešením hmotných a informačních toků spojených s pohybem zboží 

	## Spotřeba
- Lze ji spočítat 3 metodami:
  - podle technické dokumentace - v případě, že přesně známe spotřebu materiálu na jeden výrobek, např. v textilní výrobě, 
kovovýrobě,...
  - podle výtěžnosti - v případě, že neznáme spotřebu na jeden výrobek, např. výtěžnost železa ze železné rudy - používá se 
průměrná hodnota
  - indexní metoda - vychází ze spotřeby v minulém období, pokud chceme výrobu zvýšit např. o 20%, předpokládáme i zvýšení
spotřeby o 20%

- Konečná zásoba - Určuje si ji sama firma s ohledem na to, kolik bude potřebovat v dalším období
Počáteční zásoba - na začátku období si ji spočítáme při inventuře
- Nákup - to je neznámá, kterou dopočítáme z rovnice
Dodávkový cyklus - čas mezi 2 smluvními dodávkami, které se pravidelně opakují

	## Metody řízení zásob
- Metoda ABC
- Zásoby rozdělujeme do 3 skupin:
  - Skupina A - základní materiál a suroviny nutné pro výrobu, vážou až 80% finančních prostředků
  - Pro nákup využívá normování zásob:
    - Časovou normu - udává čas, na který nám vydrží průměrná zásoba, počítá se ve dnech
    - Zásoba v naturálních jednotkách - udává fyzický objem zásoby, např. litry, kusy, kilogramy,...
    - zásoba ve finančním vyjádření - udává objem peněz vázaný v zásobě v Kč
  - Skupina B - doplňkový a pomocný materiál, např. šrouby, barvy a laky, lepidla
    - hlídá se minimální skladový limit, pokud pod něj množství na skladě klesne, objednává se další
  - Skupina C - kancelářské a hygienické potřeby, např. mýdla, ručníky, papíry,...
    - hlídá se finanční normativ, pokud se vyčleněné peníze v jednom měsíci vyčerpají, může se nakupovat zase až v dalším měsíci
- Metoda JIT ("Just-in-time")
  - Materiál se naváží přímo k výrobní lince, neprochází skladem, např. automobilky
- Kanban
  - nemá sklad
  - kartičky
- OPT systém
  - využití počítačů
  - eliminace úzkých míst (na rychlý stroj navazuje několik pomalejších)
- Vytěžovací systém
  - využití auta, aby nevozilo vzduch

	Dodavatelsko - odběratelské vztahy
- Kupní smlouva 
  - Kupní smlouvou se prodávající zavazuje dodat kupujícímu movitou věc a převést na něho vlastnické právo k této věci a kupující
...
- Ústní (nedoporučuje se)
- Písemná
- Konkludentním jednáním - např. firmě přišla zásilka zboží, kterou si neobjednala. Firma tuto zásilku nevrátí a ponechá si ji. Tím 
přistupuje "mlčky" na podmínky kupní smlouvy a musí tedy zásilku zaplatit
...
- Volné zdroje pracovních sil:
  ...
  - Absolventi škol
  - Zaměstnanci přetažení od konkurence
  - Povýšení vlastních zaměstnanců
- Formy náboru:
  - Inzerce
  - Spolupráce s úřady práce a s personálními agenturami
  - Nábory na školách
...
- Uzavírá se písemně
- Výdělek podléha dani z příjmu FO

	## Péče o zaměstnance
- Poskytování dovolené na zotavenou
- Placení mezd, sociálního a zdravotního pojištění
- Péče o bezpečnost a ochranu zdraví zaměstnanců
- Sociální potřeby zaměstnanců, např. stravování, pracovní prostředí,...
- Péče o zvyšování kvalifikace
	 ## Propouštění zaměstnanců
  ## Dohodou:
  - písemný souhlas obou účastníků pracovního poměru s jeho ukončením (důvod se uvádí pouze na žádost zaměstnance)
  - PP lze ukončit k jakémukoli termínu
  ## Výpovědí:
  - jednostranný právní akt o ukončení pracovního poměru
  - musí být písemná
...
- - nepřímá - výkazy, hlášení, zprávy, porady
  ...
  - Výnosy vypočítáme, když vynásobíme prodané výkony jejich cenou
